    ...
    <footer className="bg-[#080D18] border-t border-white/10 text-[#A7B3C7] text-xs font-sans mt-6 transition-colors">
      <div className="max-w-[1400px] mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          >
            <div className="p-2 bg-[#FF6B00] rounded-xl text-white shadow-md shadow-orange-500/20 group-hover:scale-105 transition-transform">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 pt-1 relative">
            ...
            <a
              ...
              className="p-1.5 bg-[#10182A] border border-white/10 hover:border-[#FF6B00]/50 text-[#A7B3C7] hover:text-white rounded-lg transition-all cursor-pointer inline-flex items-center justify-center"
            >
            ...
            <button
              ...
              className="p-1.5 bg-[#10182A] border border-white/10 hover:border-[#FF6B00]/50 text-[#A7B3C7] hover:text-white rounded-lg transition-all cursor-pointer inline-flex items-center justify-center relative"
            >
