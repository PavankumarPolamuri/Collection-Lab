    ...
    <footer className="bg-[#080D18] border-t border-white/10 text-[#A7B3C7] text-xs font-sans mt-6 transition-colors">
      <div className="max-w-[1400px] mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
        ...
        <div className="space-y-2 md:col-span-2">
          ...
          >
            <div className="p-2 bg-[#F59E0B] rounded-xl text-black shadow-md shadow-amber-500/20 group-hover:scale-105 transition-transform">
              <Box className="w-4 h-4 stroke-[2.5]" />
            </div>
            <span className="font-extrabold text-base tracking-tight text-white">
              Collection<span className="text-[#F59E0B]">Lab</span>
            </span>
          </button>
          <p className="text-[#A7B3C7] text-[11px] leading-relaxed max-w-md font-sans">
            Custom Java Collections Visualizer implementing core data structures strictly from scratch without standard <code className="text-[#F59E0B] font-mono">java.util</code> collections.
          </p>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1 text-[11px] font-sans font-normal">
            <li>
              <button onClick={() => onSelectTab('learning')} className="hover:text-[#F59E0B] transition-colors cursor-pointer">
                Interactive Learning
              </button>
            </li>
            <li>
              <button onClick={() => onSelectTab('benchmark')} className="hover:text-[#F59E0B] transition-colors cursor-pointer">
                JVM Benchmark Suite
              </button>
            </li>
            <li>
              <button onClick={() => onOpenCodeViewer('arraylist')} className="hover:text-[#F59E0B] flex items-center gap-1 transition-colors cursor-pointer">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-1 bg-[#F59E0B]/15 hover:bg-[#F59E0B]/25 text-[#F59E0B] border border-[#F59E0B]/30 rounded-xl text-xs font-sans font-semibold transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2 pt-1 relative">
            ...
            <a
              ...
              className="p-1.5 bg-[#10182A] border border-white/10 hover:border-[#F59E0B]/50 text-[#A7B3C7] hover:text-white rounded-lg transition-all cursor-pointer inline-flex items-center justify-center"
            >
            ...
            <button
              ...
              className="p-1.5 bg-[#10182A] border border-white/10 hover:border-[#F59E0B]/50 text-[#A7B3C7] hover:text-white rounded-lg transition-all cursor-pointer inline-flex items-center justify-center relative"
            >
